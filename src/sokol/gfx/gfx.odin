...
when ODIN_OS == .Windows {
    ...
    when ODIN_ARCH == .arm64 {
        when ODIN_DEBUG == true { foreign import sokol_gfx_clib "sokol_gfx_macos_arm64_metal_debug.a" }
        else                    { foreign import sokol_gfx_clib "sokol_gfx_macos_arm64_metal_release.a" }
   } else {
        when ODIN_DEBUG == true { foreign import sokol_gfx_clib "sokol_gfx_macos_x64_metal_debug.a" }
        else                    { foreign import sokol_gfx_clib "sokol_gfx_macos_x64_metal_release.a" }
    }
}
else {
