...
when ODIN_OS == .Windows {
    ...
    when ODIN_DEBUG == true { foreign import sokol_shape_clib { "sokol_shape_linux_x64_gl_debug.lib" } }
    else                    { foreign import sokol_shape_clib { "sokol_shape_linux_x64_gl_release.lib" } }
}
