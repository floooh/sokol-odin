...
/*
    ...
    Cmdline:
        sokol-shdc -i examples/bufferoffsets/shader.glsl -o examples/bufferoffsets/shader.odin -l glsl430:metal_macos:hlsl5 -f sokol_odin
...
bufferoffsets_shader_desc :: proc "c" (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
