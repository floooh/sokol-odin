...
/*
    ...
    Cmdline:
        sokol-shdc -i examples/noninterleaved/shader.glsl -o examples/noninterleaved/shader.odin -l glsl430:metal_macos:hlsl5 -f sokol_odin
...
noninterleaved_shader_desc :: proc "c" (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
