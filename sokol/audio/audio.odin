...
when ODIN_OS == .Windows {
    ...
    when ODIN_DEBUG == true { foreign import sokol_audio_clib { "sokol_audio_linux_x64_gl_debug.a" } }
    else                    { foreign import sokol_audio_clib { "sokol_audio_linux_x64_gl_release.a" } }
}
